...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/lottie_theme_change.json
  LottieGenImage get lottieThemeChange =>
      const LottieGenImage('assets/lottie/lottie_theme_change.json');

  /// List of all assets
  List<LottieGenImage> get values => [lottieLoading, lottieThemeChange];
}
